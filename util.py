...
BARK = ''
# Server酱的SCKEY; secrets可填
SCKEY = ''
# tg机器人的TG_BOT_TOKEN; secrets可填
TG_BOT_TOKEN = ''
# tg机器人的TG_USER_ID; secrets可填
TG_USER_ID = ''
# tg机器人的TG_PROXY_IP; secrets可填
TG_PROXY_IP = ''
# tg机器人的TG_PROXY_PORT; secrets可填
TG_PROXY_PORT = ''
# 钉钉机器人的DD_BOT_ACCESS_TOKEN; secrets可填
DD_BOT_ACCESS_TOKEN = ''
...
def serverJ(title, content):
    ...
    response = requests.post(
        f"https://sc.ftqq.com/{SCKEY}.send", data=data).json()
    if response['errno'] == 0:
        print('推送成功！')
    else:
        print('推送失败！')
